...
![12](D:\work\src\go\Go-Questions\content\map\assets\12.png)
...
![13](D:\work\src\go\Go-Questions\content\map\assets\13.png)
...
![14](D:\work\src\go\Go-Questions\content\map\assets\14.png)

扩容完成后，overflow bucket 消失了，key 都集中到了一个 bucket，更为紧凑了，提高了查找的效率。

![same size 扩容](../assets/15.png)

![15](D:\work\src\go\Go-Questions\content\map\assets\15.png)

假设触发了 2 倍的扩容，那么扩容完成后，老 buckets 中的 key 分裂到了 2 个 新的 bucket。一个在 x part，一个在 y 的 part。依据是 hash 的 lowbits。新 map 中 `0-3` 称为 x part，`4-7` 称为 y part。

![2倍扩容](../assets/16.png)

![16](D:\work\src\go\Go-Questions\content\map\assets\16.png)
